                    ...
                    <Accordion className="accordian-style">
                      ...
                      {attendanceData.map((item, index) => {
                        ...
                        return (
                          ...
                          >
                            <Accordion.Header>
                           <span style={{color:"#5091b9",textTransform:"capitalize", fontSize: "14px"}}>{item.session_name}
                              <span
                                style={{
                                  fontSize: "13px",
                                  color: "#000",
                              ...
                              <span style={{color:"#5091b9",textTransform:"capitalize", fontSize: "14px", paddingLeft: "5px"}}>total attend
                              <span
                                style={{
                                  fontSize: "13px",
                                  color: "#000",
                    ...
                    <Accordion className="accordian-style">
                      ...
                      {attendanceData.map((item, index) => {
                        return (
                          ...
                          >
                            <Accordion.Header>
                            <span style={{color:"#5091b9",textTransform:"capitalize", fontSize: "14px"}}>
                              {item.session_name}
                              <span
                                style={{
                                  fontSize: "13px",
