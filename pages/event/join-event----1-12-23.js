          ...
          <div className="card">
            <div className="card-body">
              <div className="d-flex align-items-center justify-content-between my-3">
                ...
                <div className="search-field me-4">
                    <i className="bi bi-search"></i>
                    <input
                      type="number"
                      name="searchNo"
                      ...
                      currentItems?.map((val, index) => {
                        ...
                        return (
                          <tr key={index}>
                            ...
                            <td>
                              {val?.qr_path ? (
                                <img src={IMAGE_URL + val?.qr_path} className="w-75"/>
                              ) : (
                                "-"
                              )}
                            </td>
                            <td>
                              {val?.event_qr ? (
                                <img src={IMAGE_URL + val?.event_qr} className="w-75"/>
                              ) : (
                                "-"
                              )}
                            </td>
                            <td>
                              ...
                              style={{ fontSize: "19px",paddingLeft:"5px",cursor:"pointer" }}
                              onClick={() =>
                              ...
                              {/* <button
                                className="btn btn-gradient-primary d-block"
                                onClick={() =>
                                  handleSingleWhatsapp(
                                    val?.user_id,
                                    val?.event_id,
                            ...
                            <td>
                              <button
                                className={ val?.pdf_status == true ? "btn btn-gradient-primary disabled" : "btn btn-gradient-primary"}
                                onClick={
                                  val?.pdf_status == true
                                    ? null
                                    : () =>
