...
export default function joinEvent() {
  ...
  const filterData = events?.joindata?.filter((item) => {
    const contactNo = typeof item?.user_contact_no === 'string'
...
const handleSinglePdfGenerate = async (
  ...
  console.log("events?.joindata", events?.joindata);
const data = events?.joindata?.map((item)=>item)
          ...
          <div className="card">
            <div className="card-body">
              ...
              <div className="table-responsive event-Table border-all-table">
                ...
                <Table striped bordered hover className="table m-0" id='table-to-xls'>
                  <thead>
                    <tr>
                      <th width="10%">Name</th>
                      ...
                      <th width="10%">User QR</th>
                      <th width="10%">Event QR</th>
                      <th width="15%">Whatsapp Status</th>
                      <th width="10%">Pdf Status</th>
                      <th width="15%">Generate Pdf/whatsapp</th>
                    </tr>
                  </thead>
                  <tbody>
                    {isLoading == true ? (
                      ...
                      currentItems?.map((val, index) => {
                        //  console.log("val9999",val);
                        return (
                          <tr key={index}>
                            <td><span className="text_ellipes">{val?.first_name + " " + val?.last_name}</span></td>
                            <td><span className="text_ellipes" title={val?.society}>{val?.society}</span></td>
                            ...
                            <td>
                              {val?.event_qr ? (
                                <img src={IMAGE_URL + val?.event_qr} />
                              ) : (
                                "-"
                              )}
                            </td>
        ...
        {events?.joindata?.map((item, index) => {
          return (
            ...
            >
              ...
              >
                <span style={{ color: "#e14b18" }}>स्थान :</span> भारतीय कृषि,
                अनुसंधान संस्थान, मेला मैदान, पुसा रोड, नई दिल्ली
              </p>
              <div
                style={{
              ...
              <div className="user-content-box" style={{ padding: "0px 10px" }}>
                <div className="top-user-content d-flex">
                  ...
                  <div className="content-field">
                    ...
                    >
                      <span style={{ color: "#e14b18", paddingRight: "5px" }}>
                        नाम :
                      </span>{" "}
              ...
              <div className="pdf-footer-date" style={{ padding: "0px 10px" }}>
                <div className="top-user-content d-flex">
                  <div className="content-field">
                    ...
                    >
                      ★ अधिवेशन में आते समय यह परिचय पत्र साथ में लाना अनिवार्य
                      है।
                    </p>
                    <p
                      style={{
                    ...
                    >
                      ★ इस परिचय पत्र को 3.5 इंच x 5.25 इंच इस साईज में प्रिंट
                      करवाकर साथ में जरूर लाएँ ।
                    </p>
                  </div>
                  <div className="pdf-scan-field">
                    {item?.event_qr ? (
                      <img src={IMAGE_URL + item?.event_qr} width="100%" />
                    ) : (
                      "-"
                    )}
                  </div>
