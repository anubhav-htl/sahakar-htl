...
export default function AddUser() {
  ...
  const handleInput = (e) => {
    ...
    setInputValue({ ...inputValue, [name]: value,role_id: "4"});
  };
  ...
  const SubmitAddUser = async (e) => {
    ...
    const response = await fetch(API_URL + "admin-insert-user", {
      method: "POST", // or 'PUT'
      headers: {
    ...
    if (user_details.status === true) {
      ...
      setErrors([]);
      setTimeout(() => router.push("/volunteer"), 4000);
              ...
              <div className="d-flex align-items-center justify-content-between">
                <div className="col-md-6">
                  <h4 className="card-title">
                    <Link href="/volunteer" style={{ cursor: "pointer" }}>
                ...
                <div className="row form-group adduser_form">
                  ...
                  <div className="col-md-6 position-relative">
                    <label htmlFor="email" className="form-label">
                      Email<span style={{ color: "red", paddingLeft:"5px" }}> {inputValue?.role_id === "4" ? (` Password Will Send On This Email.`) : "*"}</span>
                    </label>
                    <input
                      type="text"
                      name="email"
                  ...
                  <div className="col-md-6 position-relative">
                    ...
                    <select
                      name="status"
                      id="status"
                      className="form-control apperence-disable"
                      onChange={handleInput}
                    >
