...
zipcode:  userData?.zipcode ? userData?.zipcode : "",
  ...
  if (typeof window !== "undefined") {
    var member_id = localStorage.getItem("editVolunteer");
  ...
  const HandelGetdata = async (member_id)=>{ 
    const response =  await fetch(API_URL + `volunteer-details/${member_id}`, {
      method: "GET", // or 'PUT'
      headers: {
                ...
                <div className="row form-group adduser_form">
                  ...
                  <div className="col-md-6 position-relative">
                    <label htmlFor="email" className="form-label">
                      Email<span style={{ color: "red", paddingLeft:"5px" }}>*
                      </span>
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="col-md-6 position-relative">
                    ...
                    <input
                      ...
                      id="zipcode"
                      className="form-control"
                      placeholder={userData?.role_id == 4 ? "Volunteer" : ""}
                      disabled
                    />
