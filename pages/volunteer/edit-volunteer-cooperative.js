...
export default function EditCoopSociety() {
  ...
  const handleNext = (e) => {
    ...
    if (!formData.cooperative_society_area) {
      secondError.cooperative_society_area =
        "Cooperative society area is required";
    }
      ...
      <div className="d-flex align-items-center justify-content-between">
        <div className="col-md-6">
          <h4 className="card-title">
            <Link href="/volunteer/dashboard" style={{ cursor: "pointer" }}>
